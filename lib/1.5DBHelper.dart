    ...
    return openDatabase(
      ...
      onCreate: (db, version) async {
        await db.execute(
          ...
          'CREATE TABLE mytable(id INTEGER PRIMARY KEY,DateTime INT, reaslisticString INT, investigativeString INT, artisticString INT, socialString INT, enterprisingString INT, conventionalString INT, categories1 TEXT, categories2 TEXT, categories3 TEXT, courseRecommand1 TEXT, courseRecommand2 TEXT)',
        );
      },
      version: 1,
    );
